...
// const { saveTransaction } = require('../controller/searchsave');

// Configuration constants
const CONFIG = {
  PRIVATE_KEY: 'MUyqBlkmnwobfbRbxnOc+vXZGsq/rHRvJv1lYuMIUOi89Tz4Ep9728MiJpkpPKwsGaucWYi8mCGRXyLkeP6m8Q==',
  API_ENDPOINTS: {
    SEARCH: 'https://preprod.gateway.ondc.org/search',
    STORE_RESPONSE: 'https://flashfund.kitezone.in/api/store-response'
  },
  KEY_ID: 'pl.pr.flashfund.in|58070f41-8cae-2f577-b8ca-24273d9b07b3|ed25519',
  SIGNATURE_VALIDITY: 3600000 // 1 hour in milliseconds
};
...
class SearchRequestHandler {
  ...
  static async searchRequest(requestBody, userId) {
